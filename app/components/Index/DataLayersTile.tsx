...
export default function DataLayersTile({ currentLayer, onLayerChange }: DataLayersTileProps) {
  ...
  return (
    <div 
      className="floating-tile w-64 bg-white rounded-xl shadow-xl border border-gray-200 p-4" 
      style={{ 
        position: 'absolute',
        bottom: '20px', 
        left: '20px',
    ...
    >
      <h3 className="text-sm font-semibold text-gray-900 mb-4">Data Layers</h3>
          ...
          return (
            ...
            >
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 mt-1 text-gray-500">{layer.icon}</div>
